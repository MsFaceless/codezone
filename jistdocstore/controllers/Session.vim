...
badd +0 ../lib/jist_transport_reportlab.py
badd +0 ../lib/jist_labour_reportlab.py
badd +0 ../lib/jistfileuploader.py
badd +0 ../lib/jist_google_reportlab.py
badd +1 ../lib/jist_generic_reportlab.py
badd +1 jist_labour_reportlab.py
...
62
normal zo
let s:l = 38 - ((11 * winheight(0) + 11) / 22)
...
10
normal zo
let s:l = 28 - ((0 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
28
...
12
normal zo
let s:l = 7 - ((0 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
7
normal! 08l
tabedit ../lib/jistfileuploader.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
213
normal zo
let s:l = 206 - ((13 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
206
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 54 - ((0 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
54
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 6483 - ((13 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
6483
...
291
normal zo
let s:l = 756 - ((35 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
756
normal! 0
tabedit ../lib/jist_labour_reportlab.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
set winheight=1 winwidth=1
argglobal
edit ../lib/jist_labour_reportlab.py
let s:cpo_save=&cpo
set cpo&vim
iabbr <buffer> iff if object: <Left>
let &cpo=s:cpo_save
...
718
normal zo
let s:l = 624 - ((151 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
624
...
1821
normal zo
let s:l = 759 - ((0 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
759
