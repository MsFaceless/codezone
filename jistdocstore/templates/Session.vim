...
badd +1 contracts/logopage.html
badd +0 master.html
badd +0 cctv/cctvindex.html
badd +0 management/managementindex.html
badd +0 production/productionindex.html
badd +0 production/contacts_console.html
badd +0 production/site_address_console.html
badd +0 production/fileuploadconsole.html
args myjistconsole.html
edit myjistconsole.html
...
4
normal zo
let s:l = 182 - ((14 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
182
normal! 0
tabedit production/productionindex.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
15
normal zo
let s:l = 26 - ((10 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
26
normal! 0
tabedit production/contacts_console.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
4
normal zo
let s:l = 81 - ((21 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
81
normal! 0
tabedit production/site_address_console.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
4
normal zo
let s:l = 62 - ((16 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
62
normal! 041l
tabedit contracts/logopage.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
4
normal zo
let s:l = 127 - ((43 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
127
...
normal! zt
42
let s:c = 154 - ((39 * winwidth(0) + 105) / 211)
if s:c > 0
  exe 'normal! 0' . s:c . 'lzs' . (154 - s:c) . 'l'
else
  normal! 0154l
endif
tabedit management/managementindex.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
