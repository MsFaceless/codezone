# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in rocket.
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': rocket.model,
    'DBSession': rocket.model.DBSession,
})
...
class ApplicationAuthMetadata(TGAuthMetadata):
    ...
    def authenticate(self, environ, identity):
        ...
        user = self.dbsession.query(self.user_class).filter_by(username=login).first()
    ...
    def get_user(self, identity, userid):
        return self.dbsession.query(self.user_class).filter_by(username=userid).first()

    def get_roles(self, identity, userid):
        return [g.group_name for g in identity['user'].roles]
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "6f35891e-d291-4f83-baa1-59b61dd82ec6",
