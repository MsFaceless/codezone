...
# Utilities
CoverAndExclusionType = get_type_table(model_name='CoverAndExclusion', table_name='cover_and_exclusion') # All Death, Suicide, etc.
...
columns_tbl_benefit = {
    ...
    'entity_org_insurer_id': common_columns.get('integer')(),
    ...
    'benefit_cover_link_id': common_columns.get('integer')(),
...
columns_tbl_benefit_rate_table = {
    ...
    'has_sum_assured_limits': common_columns.get('boolean_default_false')(),
}
BenefitRateTable = get_phat_table(model_name='BenefitRateTable', columndict=columns_tbl_benefit_rate_table)

columns_tbl_benefit_rate_table_premium_limit = {
    '__tablename__': 'tbl_benefit_rate_table_premium_limit',
    'minimum_premium': common_columns.get('currency_not_nullable')(),
    'maximum_premium': common_columns.get('currency_not_nullable')(),
}
BenefitRateTablePremiumLimit = get_phat_table(model_name='BenefitRateTablePremiumLimit', columndict=columns_tbl_benefit_rate_table_premium_limit)

columns_tbl_benefit_rate_table_sum_assured_limit = {
    '__tablename__': 'tbl_benefit_rate_table_sum_assured_limit',
    'minimum_sum_assured': common_columns.get('currency_not_nullable')(),
    'maximum_sum_assured': common_columns.get('currency_not_nullable')(),
}
BenefitRateTableSumAssuredLimit = get_phat_table(model_name='BenefitRateTableSumAssuredLimit', columndict=columns_tbl_benefit_rate_table_sum_assured_limit)
...
RateTableBaseValue = get_phat_table(model_name='RateTableBaseValue', columndict=columns_tbl_rate_table_base_value)
